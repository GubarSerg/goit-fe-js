...
class Hamburger {
   ...
   */
  get price() {
    return Hamburger.SIZES[this._size].price + Hamburger.STUFFINGS[this._stuffing].price + this._toppings.reduce((acc, topp) => acc + Hamburger.TOPPINGS[topp].price, 0);
  }
   ...
   */
  get calories() {
    return Hamburger.SIZES[this._size].calories + Hamburger.STUFFINGS[this._stuffing].calories + this._toppings.reduce((acc, topp) => acc + Hamburger.TOPPINGS[topp].calories, 0);
  }
}
