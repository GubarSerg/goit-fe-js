...
// const getSummOfValues = Object.values(order).reduce((acc, value) => acc + value, 0)

// console.log(getSummOfValues); // 150
...
// const allGuestsActive = guests => guests.every(user => user.isActive)
